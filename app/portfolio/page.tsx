...
// Fetches all public-tagged photos from the DB, grouped by category.
// The PortfolioClient component handles client-side filter tab state.
...
export const metadata: Metadata = {
  title: "Portfolio",
  description:
    "The full collection — weddings, portraits, editorial, and landscape work by Korrin.",
};
...
export default async function PortfolioPage() {
  ...
  try {
    ...
    // DB not yet available — use dev placeholders
  }
  ...
  return (
    <div style={{ paddingTop: "72px" }} className="page-fade-in">
      ...
      {/* Filter tabs + grid — client component handles tab state */}
